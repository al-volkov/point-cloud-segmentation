import unittest
import numpy as np
from src.point_projector.point_projector_core_vectorized import PointProjectorCoreVectorized
...
class TestPointProjectorCoreVectorized(unittest.TestCase):
    ...
    def test_convert_coordinates(self):
        ...
        converted_coordinates = self.point_projector.convert_coordinates(original_coordinates)
    ...
    def test_rotate_vector(self):
        ...
        rotated_vectors = self.point_projector.rotate_vector(vector_coordinates, self.camera_angles[np.newaxis, :, :])
        self.assertIsInstance(rotated_vectors, np.ndarray)

    def test_get_rotation_matrix(self):
        rotation_matrices = self.point_projector.get_rotation_matrix(self.camera_angles[np.newaxis, :, :])
