...
class TestLazyImageLoader(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(all(isinstance(i, str) for i in self.lazy_image_loader.image_names))
    ...
    def test_len(self):
        self.assertEqual(len(self.lazy_image_loader), len(self.lazy_image_loader.image_names))
